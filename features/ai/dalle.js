...
module.exports = {
    ...
    run: async (m, {
        ...
        let data = await Func.fetchJson("https://itzpire.com/ai/dalle?prompt=" + text)
    ...
    description: "masukan prompt untuk membuat gambar dengan model DALL-E, cara penggunaan sudah tersedia diatas"
}