...
module.exports = {
    ...
    run: async (m, {
        ...
        let data = await Func.fetchJson("https://itzpire.com/ai/3dmodel?prompt=" + text + "&negative_prompt=blur")
        kgy.sendMessage(m.chat, {
         image: { url: data.result }, caption: `*• Prompt :* ${text}` },{ quoted: m });
    },
    ...
    description: "masukan prompt untuk membuat gambar dengan model 3D cartoon, cara penggunaan sudah tersedia diatas"
}