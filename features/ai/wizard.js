...
module.exports = {
    help: ["wizard"], //nama fitur kamu
    usage: "*Input question*", //deskripsi singkat
    command: ["wizard"], //untuk eksekusi fitur nya
    ...
    run: async (m, {
        ...
        let {
            data
        } = await axios.post("https://imphnen-ai.vercel.app/api/llm/wizard_lm", json);
    ...
    description: "Jawab Semua pertanyaan mu dengan Wizard Ai"
}